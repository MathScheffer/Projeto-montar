...
const { Usuario, Processador, PlacaMae, Ram, Armazenamento, Vga, Fonte, ComputadorArmazenamento, ComputadorRam } = require('../model');
            ...
            include:[
                {
                    ...
                    association: await Computador.relation("ComputadorArmazenamento")
                }*/{
